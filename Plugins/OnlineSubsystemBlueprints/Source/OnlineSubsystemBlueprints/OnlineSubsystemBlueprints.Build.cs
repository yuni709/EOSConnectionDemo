...
#if UE_5_2_OR_LATER
        this.PrivateDefinitions.Add("UE_5_2_OR_LATER=1");
#endif
#if UE_5_1_OR_LATER
        this.PrivateDefinitions.Add("UE_5_1_OR_LATER=1");
#endif
#if UE_5_0_OR_LATER
...
#if UE_5_2_OR_LATER && !UE_5_3_OR_LATER
        Console.WriteLine("Online Subsystem Blueprints: Targeting Unreal Engine 5.2.");
        this.ConditionalAddModuleDirectory(new DirectoryReference(Path.Combine(this.ModuleDirectory, "..", "OnlineSubsystemBlueprints_5.2")));
#elif UE_5_1_OR_LATER && !UE_5_2_OR_LATER
        Console.WriteLine("Online Subsystem Blueprints: Targeting Unreal Engine 5.1.");
        this.ConditionalAddModuleDirectory(new DirectoryReference(Path.Combine(this.ModuleDirectory, "..", "OnlineSubsystemBlueprints_5.1")));
#elif UE_5_0_OR_LATER && !UE_5_1_OR_LATER
