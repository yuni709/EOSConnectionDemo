...
public:
    ...
    EJoinRequestAction_ JoinRequestAction = EJoinRequestAction_::Manual;

    /* Who can see this party and join it through presence? */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Online")
    EPartySystemPermissions PresencePermissions = EPartySystemPermissions::Noone;

    /* Who can send out invites to other users when they're in this party? */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Online")
    EPartySystemPermissions InvitePermissions = EPartySystemPermissions::Noone;
