...
public:
    ...
    // @generator-incompatible
    // IOnlinePartyJoinInfoConstPtr MakeJoinInfo(const FUniqueNetId& LocalUserId, const FOnlinePartyId& PartyId);
    ...
    // @generator-incompatible
    // FDelegateHandle AddOnPartyInviteReceivedDelegate_Handle(const FOnPartyInviteReceivedDelegate& Delegate);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(FOnlinePartySubsystemCancelInvitationCallbackPin, FUniqueNetIdRepl, SenderUserId, UPartyId*, PartyId, FUniqueNetIdRepl, TargetUserId, FOnlineErrorInfo, Result);
...
public:
    ...
    static UOnlinePartySubsystemCancelInvitation* CancelInvitation(
        UOnlinePartySubsystem* Subsystem
        ,FUniqueNetIdRepl LocalUserId, FUniqueNetIdRepl TargetUserId, UPartyId* PartyId
    );
...
private:
    ...
    UPROPERTY()
    FString __Store__CallUniquenessId;
    void HandleCallback_OnCancelPartyInvitationComplete(const FUniqueNetId& SenderUserId, const FOnlinePartyId& PartyId, const FUniqueNetId& TargetUserId, const FOnlineError& Result);
