...
UOnlineSessionSubsystem::UOnlineSessionSubsystem()
{
    ...
    if (Handle.IsValid())
    {
        ...
        this->DelegateHandle_OnSessionParticipantJoined = Handle->AddOnSessionParticipantJoinedDelegate_Handle(
            FOnSessionParticipantJoined::FDelegate::CreateWeakLambda(this, [this](FName Param1, const FUniqueNetId& Param2) {
                this->OnSessionParticipantJoined.Broadcast(Param1, ConvertDangerousUniqueNetIdToRepl(Param2));
            })
        );
        this->DelegateHandle_OnSessionParticipantLeft = Handle->AddOnSessionParticipantLeftDelegate_Handle(
            FOnSessionParticipantLeft::FDelegate::CreateWeakLambda(this, [this](FName Param1, const FUniqueNetId& Param2, EOnSessionParticipantLeftReason Param3) {
                this->OnSessionParticipantLeft.Broadcast(Param1, ConvertDangerousUniqueNetIdToRepl(Param2), (EOnSessionParticipantLeftReason_)(Param3));
            })
        );
...
void UOnlineSessionSubsystemStartMatchmaking::Activate()
{
    ...
    if (!(ValidateArrayElements<FUniqueNetIdRepl>(this->__Store__LocalPlayers, [](const FUniqueNetIdRepl& Val) { return Val.IsValid() && Val.GetUniqueNetId().IsValid(); })))
    {
...
bool UOnlineSessionSubsystem::SendSessionInviteToFriends(FUniqueNetIdRepl LocalUserId, FName SessionName, TArray<FUniqueNetIdRepl> Friends)
{
    ...
    if (!(ValidateArrayElements<FUniqueNetIdRepl>(Friends, [](const FUniqueNetIdRepl& Val) { return Val.IsValid() && Val.GetUniqueNetId().IsValid(); })))
    {
        return false;
    }
...
void UOnlineSessionSubsystemRegisterPlayers::Activate()
{
    ...
    if (!(ValidateArrayElements<FUniqueNetIdRepl>(this->__Store__Players, [](const FUniqueNetIdRepl& Val) { return Val.IsValid() && Val.GetUniqueNetId().IsValid(); })))
    {
