...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FSession_SessionParticipantJoined_BP, FName, Param1, FUniqueNetIdRepl, Param2);

DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FSession_SessionParticipantLeft_BP, FName, Param1, FUniqueNetIdRepl, Param2, EOnSessionParticipantLeftReason_, Param3);
